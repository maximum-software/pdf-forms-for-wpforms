...
if( ! class_exists('Pdf_Forms_For_WPForms') )
{
	class Pdf_Forms_For_WPForms
	{
		...
		const MAX_WPFORMS_VERSION = '1.10.99';
		...
		public function add_settings_content( $instance )
		{
			...
			echo self::render( "spinner" ).
				...
				'field-mapping-help' => esc_html__( 'This tool can be used to link form fields and smart tags to fields in the attached PDF files. WPForms fields can also be generated from PDF fields. When your users submit the form, input from form fields and other smart tags will be inserted into the corresponding fields in the PDF file. WPForms to PDF field value mappings can also be created to enable the replacement of WPForms data when PDF fields are filled.', 'pdf-forms-for-wpforms' ),
				...
				'help-message' => self::replace_tags(
					esc_html__( "Have a question/comment/problem?  Feel free to use {a-href-forum}the support forum{/a} and view {a-href-tutorial}the tutorial video{/a}.", 'pdf-forms-for-wpforms' ),
					array(
						'a-href-forum' => '<a href="https://wordpress.org/support/plugin/pdf-forms-for-wpforms/" target="_blank">',
						'a-href-tutorial' => '<a href="https://youtu.be/3V2k7ITVNlo" target="_blank">',
						'/a' => '</a>',
					)
				),
