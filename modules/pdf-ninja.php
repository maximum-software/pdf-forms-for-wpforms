...
class WPForms_Pdf_Ninja extends Pdf_Forms_For_WPForms_Service
{
	...
	{
		wp_register_script( 'pdf_forms_for_wpforms_pdfninja_panel_script', plugin_dir_url(__FILE__) . '../js/pdf-ninja-settings.js', array('jquery'), Pdf_Forms_For_WPForms::VERSION );
