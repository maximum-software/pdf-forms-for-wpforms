...
if( ! class_exists( 'Pdf_Forms_For_WPForms_Downloads' ) )
{
	class Pdf_Forms_For_WPForms_Downloads
	{
		...
		private function __construct()
		{
			...
			$subdir = 'pdf_forms_for_wpforms_downloads';
			$this->downloads_path = path_join( $uploads['basedir'], $subdir );
			$this->downloads_url = $uploads['baseurl'] . '/' . $subdir;
			if( defined( 'PDF_FORMS_FOR_WPFORMS_DOWNLOADS_TIMEOUT_SECONDS' ) )
				$this->downloads_timeout = PDF_FORMS_FOR_WPFORMS_DOWNLOADS_TIMEOUT_SECONDS;
		}
		 ...
		 */
		public function add_file( $srcfile, $filename, $metadata )
		{
